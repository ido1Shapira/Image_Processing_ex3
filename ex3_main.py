...
def blendDemo():
    im1 = cv2.cvtColor(cv2.imread('view.jpg'), cv2.COLOR_BGR2RGB) / 255
    im2 = cv2.cvtColor(cv2.imread('moon.jpg'), cv2.COLOR_BGR2RGB) / 255
    mask = cv2.cvtColor(cv2.imread('mask_moon.jpg'), cv2.COLOR_BGR2RGB) / 255
